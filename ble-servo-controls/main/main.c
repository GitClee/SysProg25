 ...
 * Servo: MC-410
 * 
 * About: Control the Servo over Bluetooth connection
 * Connect Servo to ESP32-S3:
 *      - Red cable to 3.3V
 *      - Brown cable to GND
 *      - Orange cable to PIN 4 (Signal)
*/
...
static const ble_uuid128_t UART_SERVICE_UUID = BLE_UUID128_INIT(
    0x6e, 0x40, 0x00, 0x01, 0xb5, 0xa3, 0xf3, 0x93,
    0xe0, 0xa9, 0xe5, 0x0e, 0x24, 0xdc, 0xca, 0x9e);

static const ble_uuid128_t UART_CHAR_UUID_RX = BLE_UUID128_INIT(
    0x6e, 0x40, 0x00, 0x02, 0xb5, 0xa3, 0xf3, 0x93,
    0xe0, 0xa9, 0xe5, 0x0e, 0x24, 0xdc, 0xca, 0x9e);

static const ble_uuid128_t UART_CHAR_UUID_TX = BLE_UUID128_INIT(
